# TunnelTanks.Desktop — Platform Layer

Thin SDL2-based shell that wires the platform-independent `TunnelTanks.Core` to a real window, keyboard, and mouse. Contains 4 files.
