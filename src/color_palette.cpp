...
ColorPalette::ColorPalette()
{
    ...
    Set(Colors::EnergyShieldPassive, Color(0xa0, 0xa0, 0x19, 0x2f));
    Set(Colors::EnergyShieldActive, Color(0xd0, 0xd0, 0x30, 0x7f));
    Set(Colors::DirtShieldPassive, Color(0xff, 0xa0, 0x19, 0x2f));
    Set(Colors::DirtShieldActive, Color(0xff, 0xd0, 0x30, 0x7f));
