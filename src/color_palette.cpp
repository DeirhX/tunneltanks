...
ColorPalette::ColorPalette()
{
    ...
    Set(Colors::HarvesterOutline, Color(0x9f, 0xff, 0xff, 0x80));
    Set(Colors::ChargerInside, Color(0x4f, 0x4f, 0xff, 0xa0));
    Set(Colors::ChargerOutline, Color(0x7f, 0x7f, 0xff, 0xa0));
    ...
    Set(Colors::MaterialStatusOutline, Color(0x00, 0xff, 0xff, 0x1f));
    Set(Colors::MaterialStatusFill, Color(0x00, 0xff, 0xff, 0x9f));
    Set(Colors::FailedInteraction, Color(0xff, 0x34, 0x08));
