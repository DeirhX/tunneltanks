...
namespace widgets
{
    ...
    struct BitmapRender : public GuiWidget
    {
      ...
      public:
        BitmapRender(ScreenRect screen_rect, MonoBitmap & bitmap_data, Color color)
    ...
    class ResourcesMinedDisplay : public GuiWidget
    {
      ...
      public:
        ResourcesMinedDisplay(ScreenRect screen_rect, HorizontalAlign alignment, Tank & tank)
